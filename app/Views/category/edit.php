            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-sm-4 text-left">Category - Edit</div>
...
<?= $this->section('footer') ?>
    <script type="text/javascript">
        getSingleCategory('<?php echo $uri->getSegment(3); ?>', 'edit');

        $(document).on('submit', '#category-update-form', function(e) {
            e.preventDefault();
            updateCategory('#category-update-form', '<?php echo $uri->getSegment(3); ?>');
        });
    </script>
<?= $this->endSection() ?>